...
GPLOT jest narzędziem do przetwarzania plików CGM (Computer Graphics
Metafile). Pliki CGM występują w trzech rodzajach: binarnym
(najczęściej), czystym tekście (czytelnym) i znakowym (7 bitów/bajt).
